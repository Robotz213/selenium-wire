...
from selenium.webdriver import ChromeOptions, DesiredCapabilities, EdgeOptions
...
SELENIUM_V4 = parse_version(getattr(selenium, "__version__", "0")) >= parse_version(
    "4.0.0"
)
...
class DriverCommonMixin:
    ...
    def proxy(self) -> dict[str, Any]:
        ...
        conf = {}
        mode = self.backend.master.options.mode
        ...
        custom_auth = self.backend.master.options.upstream_custom_auth
...
class Safari(InspectRequestsMixin, DriverCommonMixin, _Safari):
    ...
    def __init__(self, seleniumwire_options=None, *args, **kwargs):
        ...
        assert "port" in seleniumwire_options, (
